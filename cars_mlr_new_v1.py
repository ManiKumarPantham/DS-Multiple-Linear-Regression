...
# p-values of coefficients found to be insignificant due to collinearity

# Identify the variale with highest collinearity using Variance Inflation factor (VIF)
# Variance Inflation Factor (VIF)
# Assumption: VIF > 10 = collinearity
# VIF on clean Data
vif = pd.Series([variance_inflation_factor(P.values, i) for i in range(P.shape[1])], index = P.columns)
vif
# inf = infinity

# col on Index 4 shows highest VIF 
...
## Testing
data = pd.read_csv(r"C:\Users\Bharani Kumar\Desktop\Data Science using Python & R\Version 2 slides\Datasets\Multiplelinear Regression\Cars_test.csv")
